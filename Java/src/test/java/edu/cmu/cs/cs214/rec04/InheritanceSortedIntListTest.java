...
public class InheritanceSortedIntListTest {
    ...
    System.out.println("at beginning list 1 has: " + list1.getTotalAdded());
    System.out.println("at beginning list 2 has: " + list2.getTotalAdded());
    ...
    System.out.println("list2 totalAdded after addAll: " + list2.getTotalAdded());
